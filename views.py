...
def PostSent(request):
    ...
    if request.method == 'POST' and request.FILES['t2']:
        ...
        filename = fs.save('E:/klaus/B12-Identification of Online Child Predators and Cyber Harassers in Social Media Environments/CyberBullying/static/photo/'+str(myfile), myfile)
